...
const BoxGridHouses = ({houses,numberCols}:any) => {
    return (  
    <section className=" px-10 py-4 w-full h-full flex flex-col">
    <div className={`w-full h-full grid grid-cols-${numberCols} gap-4 px-10 `}>
          ...
          <Link href={`/houses/${house.id}`}>
            <div className="w-full h-full relative">
              <img
                src={house.images[0]}
                alt={house.name}
                className="w-full h-[280px] object-cover brightness-75 rounded-md"
              />
