    ...
    <section className="w-full ">
     <div className="flex w-full mt-10   gap-3 px-2">
        ...
        <div className="w-[50%] h-full flex flex-col gap-8 ">
              ...
              <div className="">
                <p>Valor R$ <span className="font-bold text-[#333]">{house?.price?.toLocaleString("pt-br",{styled:"currency",currency:"BRL"} as any)}</span></p>
              </div>
        </div>
     ...
     <div className="px-2 py-2">
        ...
        <h1>Registro Creci: <span className="text-[#333] font-bold"> {house?.User?.creci as any} / {house?.User?.creciUF}</span></h1>
